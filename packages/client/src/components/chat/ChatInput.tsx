...
const ChatInput = ({
  ...
  return (
    <form
      ...
      className="group relative flex flex-col gap-2 rounded-28 border border-glass-border bg-glass-bg px-4 py-3 shadow-lg backdrop-blur-2xl transition focus-within:border-brand-primary/50 focus-within:bg-glass-bg-active focus-within:shadow-[0_0_40px_var(--shadow-brand)]"
